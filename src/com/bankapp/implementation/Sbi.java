...
public class Sbi {
	public static int sbi_acctnum=3000;
	...
	{	
		...
		switch (s)
		{
		case "1": System.out.println("SBI Car Loan interestRate is 9.65% ");
		break;

		case "2":System.out.println("SBI Two wheeler Loan interestRate is 11.37%");
		break;

		case "3":System.out.println("SBI Home Loan interestRate is 9.45%");
		break;

		case "4":System.out.println("SBI Personal Loan interestRate is 15.75%");
		break;
