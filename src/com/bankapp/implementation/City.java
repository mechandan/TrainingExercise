...
public class City {
	...
	public static int city_acctnum=4000;
	...
	{	
		...
		switch (s)
		{
		case "1": System.out.println("City Bank Car Loan interestRate is 9.65% ");
		break;

		case "2":System.out.println("City Bank Two wheeler Loan interestRate is 11.37%");
		break;

		case "3":System.out.println("City Bank Home Loan interestRate is 9.45%");
		break;

		case "4":System.out.println("City Bank Personal Loan interestRate is 15.75%");
		break;
	...
	System.out.println("\n The IFSC Code for"+" "+s3+ "Branch is 018276");
	}
	catch(Exception e)
	{
		e.printStackTrace();
