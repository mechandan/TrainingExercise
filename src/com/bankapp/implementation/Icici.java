...
public class Icici {
	public static int icici_acctnum=2000;
...
//		Scanner in =new Scanner(System.in);
		...
		public void interestRate_loanEnquiry()
		{
			...
			switch (s)
			{
			case "1": System.out.println("ICICI Car Loan interestRate is 9.65% ");
			break;

			case "2":System.out.println("ICICI Two wheeler Loan interestRate is 11.37%");
			break;

			case "3":System.out.println("ICICI Home Loan interestRate is 9.45%");
			break;

			case "4":System.out.println("ICICI Personal Loan interestRate is 15.75%");
			break;
		...
		public void ifscCodeEnquiry()
		{
			...
			System.out.println("\n The IFSC Code for"+" "+s3+" "+ "Branch is ICIC0003592 ");
			}
			catch(Exception e)
			{
				e.printStackTrace();
